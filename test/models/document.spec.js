...
// const documentHelper = helper.fakeDocument;
// const userHelper = helper.fakeUser;

// const requiredFields = ['title', 'content', 'access', 'userId'];

// describe('DOCUMENT MODEL', () => {
//   // before(() => model.sequelize.sync({ force: true }));
//   describe('THE WORKING OF THE DOCUMENT MODEL', () => {
//     let document;
//     let user;

//     before((done) => {
//       model.Role.create(helper.fakeRole)
//         .then((createdRole) => {
//           userHelper.roleId = createdRole.id;
//           return model.User.create(userHelper);
//         })
//         .then((createdUser) => {
//           user = createdUser;
//           documentHelper.userId = user.id;
//           done();
//         });
//     });

//     beforeEach(() => {
//       document = model.Document.build(documentHelper);
//     });
...
//         });
//     });
//     xit('should create a document with title and content', (done) => {
//       document.save()
//         .then((createdDocument) => {
//           expect(createdDocument.title).to.equal(documentHelper.title);
//           expect(createdDocument.content).to.equal(documentHelper.content);
//           done();
//         });
//     });
//     xit('should create a document with correct userId', (done) => {
//       document.save()
//         .then((createdDocument) => {
...
//         });
//     });
//     xit('should create a document with publish date', (done) => {
//       document.save()
//         .then((createdDocument) => {
//           expect(createdDocument.createdAt).to.exist;
//           done();
//         });
//     });
//     xit('should create a document with access set to public', (done) => {
//       document.save()
//         .then((createdDocument) => {
//           expect(createdDocument.access).to.equal('public');
//           done();
...
//     xdescribe('Document Model Validations', () => {
//       describe('Required Fields Validation', () => {
//         requiredFields.forEach((field) => {
//           it(`requires a ${field} field to create a document`, () => {
//             document[field] = null;
//             return document.save()
//               .catch((error) => {
//                 expect(/notNull Violation/.fake(error.message)).to.be.true;
//               });
//           });
//         });
//       });
